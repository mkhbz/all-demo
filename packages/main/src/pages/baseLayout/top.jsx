...
const Top = function (props) {
    ...
    const changeAjax = () => {
        ...
        return (dispatch) => {
            ...
            dispatch(
                { type: REDUCER_CONST.ADD_USERI_NFO, payload: { nickName: 'mk', age: 'mk', name: 'mk' } }
    ...
    return (
        <><div className="logo" />
            {user.nickName ?
                <div onClick={handleLogout} className='nickName'>{user?.nickName}</div>
                : <div onClick={handleLogin} className='nickName'>点击登录</div>
